...
PyObject *const_str_digest_1a5dc91bd7cd71ee46184b9fb8cebe26;
...
static void _createGlobalConstants( void )
{
    ...
    const_str_plain_end = UNSTREAM_STRING( &constant_bin[ 88 ], 3, 1 );
    const_str_plain_int = UNSTREAM_STRING( &constant_bin[ 91 ], 3, 1 );
    const_str_plain_len = UNSTREAM_STRING( &constant_bin[ 94 ], 3, 1 );
    const_str_plain_sum = UNSTREAM_STRING( &constant_bin[ 97 ], 3, 1 );
    const_str_plain_file = UNSTREAM_STRING( &constant_bin[ 100 ], 4, 1 );
    const_str_plain_iter = UNSTREAM_STRING( &constant_bin[ 104 ], 4, 1 );
    const_str_plain_name = UNSTREAM_STRING( &constant_bin[ 108 ], 4, 1 );
    const_str_plain_open = UNSTREAM_STRING( &constant_bin[ 112 ], 4, 1 );
    ...
    const_str_plain_fromlist = UNSTREAM_STRING( &constant_bin[ 272 ], 8, 1 );
    const_str_plain___class__ = UNSTREAM_STRING( &constant_bin[ 280 ], 9, 1 );
    const_str_plain___enter__ = UNSTREAM_STRING( &constant_bin[ 289 ], 9, 1 );
    const_str_plain___cached__ = UNSTREAM_STRING( &constant_bin[ 298 ], 10, 1 );
    const_str_plain___import__ = UNSTREAM_STRING( &constant_bin[ 308 ], 10, 1 );
    const_str_plain___loader__ = UNSTREAM_STRING( &constant_bin[ 318 ], 10, 1 );
    const_str_plain___module__ = UNSTREAM_STRING( &constant_bin[ 328 ], 10, 1 );
    const_str_plain___builtins__ = UNSTREAM_STRING( &constant_bin[ 338 ], 12, 1 );
    const_str_plain___metaclass__ = UNSTREAM_STRING( &constant_bin[ 350 ], 13, 1 );
    const_str_digest_1a5dc91bd7cd71ee46184b9fb8cebe26 = UNSTREAM_STRING( &constant_bin[ 363 ], 69, 0 );

#if _NUITKA_EXE
    /* Set the "sys.executable" path to the original CPython executable. */
    PySys_SetObject(
        (char *)"executable",
        const_str_digest_1a5dc91bd7cd71ee46184b9fb8cebe26
    );
#endif
}
